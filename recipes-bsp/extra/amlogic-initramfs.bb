...
PACKAGE_INSTALL = "kmod initramfs-boot-am parted e2fsprogs busybox udev base-passwd ${ROOTFS_BOOTSTRAP_INSTALL}"
PACKAGE_INSTALL_append_alien5 += "linkdroid-nftl-dev-alien5"
